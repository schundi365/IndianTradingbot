...
def config_api():
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            # Validate confidence
            confidence = new_config.get('min_trade_confidence', 0)
            ...
            print(f"DEBUG: Validating max_daily_loss = {max_daily_loss}")  # Debug print
            if max_daily_loss < 10 or max_daily_loss > 1000:
                return jsonify({'status': 'error', 'message': 'Max daily loss must be between $10 and $1000'})
            ...
            if 'macd_min_histogram' in new_config:
                macd_threshold = new_config.get('macd_min_histogram', 0.0005)
