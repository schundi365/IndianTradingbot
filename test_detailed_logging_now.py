#!/usr/bin/env python3
"""
Test detailed logging immediately
"""
...
def test_detailed_logging():
    ...
    try:
        ...
        # Test the calculate_indicators_with_logging method
        print("\n🔍 Testing calculate_indicators_with_logging...")
        print("=" * 60)
        
        result_df = bot.calculate_indicators_with_logging(df)
...
if __name__ == "__main__":
    ...
    if success:
        print("\n✅ DETAILED LOGGING TEST PASSED!")
        print("📝 The fix is working - detailed logging should now appear in the bot")
    else:
