...
hypothesis.settings.register_profile("fast", max_examples=50, deadline=5000)
...
@settings(max_examples=15, deadline=15000, suppress_health_check=[hypothesis.HealthCheck.filter_too_much])
